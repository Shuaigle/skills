...
Scan the directory holding the records for the highest existing number and increment by one. Where the repo numbers them some other way, follow that instead.
